 ...
 */
  ...
  template:   ' <div>' +
              ...
              '         <b-container fluid align-h="center" class="px-0 mx-0 mb-2" v-if="((data_mode == architecture.components[item.index].type && data_mode !== \'v_registers\') || (data_mode == \'int_registers\' && architecture.components[item.index].type == \'ctrl_registers\')) && (data_mode !== \'v_registers\' || architecture.components[item.index].type == \'v_registers\') ">' +
